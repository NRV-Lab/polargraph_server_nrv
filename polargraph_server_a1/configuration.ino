...
#define MOTOR_A_ENABLE_PIN 2 //47
#define MOTOR_A_STEP_PIN 6  //49
#define MOTOR_A_DIR_PIN 7   //51

#define MOTOR_B_ENABLE_PIN 3  //27
#define MOTOR_B_STEP_PIN 5     //23
#define MOTOR_B_DIR_PIN 4     //25
